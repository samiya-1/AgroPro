...
import 'package:helloworld/Adminnoti.dart';
...
class _AdminNotifyState extends State<AdminNotify> {
  ...
  _fetchData() async {
    var res = await Api()
        .getData('/api/adminNotifications');
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      setState(() {
                        _selectedIndex = 0; // Set selected index to 0 for "Admin"
                      });
                  ...
                  TextButton(
                    onPressed: () {
                      setState(() {
                        _selectedIndex = 1; // Set selected index to 1 for "Krishibhavan"
                      });
