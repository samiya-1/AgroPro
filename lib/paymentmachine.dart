...
class Paymentmachinebuy extends StatefulWidget {
  final double result;
  Paymentmachinebuy({ required this.result});

  @override
  State<Paymentmachinebuy> createState() => _PaymentmachinebuyState();
}

class _PaymentmachinebuyState extends State<Paymentmachinebuy> {
