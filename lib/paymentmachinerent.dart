...
class Paymentmachinerent extends StatefulWidget {
  final double result;
  Paymentmachinerent({ required this.result});

  @override
  State<Paymentmachinerent> createState() => _PaymentmachinerentState();
}

class _PaymentmachinerentState extends State<Paymentmachinerent> {
