...
//
    ...
    children: [
      ...
      //Text(_loaddata[index]['product'],style: TextStyle(fontSize: 16),textAlign: TextAlign.justify,),
      SizedBox(height: 5,),

      Text(_loaddata[index]['date'],style: TextStyle(fontSize: 16),textAlign: TextAlign.justify,),
      //SizedBox(height: 5,),

     Text(_loaddata[index]['total_amount'],style: TextStyle(fontSize: 16),textAlign: TextAlign.justify,),
