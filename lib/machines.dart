...
import 'package:helloworld/Add_machine.dart';
import 'package:helloworld/Addmachine.dart';
import 'package:helloworld/singlemachinedetails.dart';
    ...
    return SafeArea(
        child: Scaffold(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                Navigator.push(context,
                                                    MaterialPageRoute(builder: (context) => Single_Machine(id: mid,)));
                                              },
                                              child: Column(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            label: const Text('Add New Machine'),
